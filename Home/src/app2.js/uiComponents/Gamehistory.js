...
const Gamehistory = () => {
  ...
  const fetchRoomCode = async (gameId) => {
    ...
    try {
      const response = await axios.get(
        `${baseUrl}game/roomcode/get/${gameId}`,
        { headers }
      );
  ...
  const Allgames = async (id) => {
    ...
    try {
      ...
      const filteredGames = res.data.data.filter((ele) =>
      ...
      >
        ...
        {game &&
          game.map((card) => (
            ...
            >
              ...
              <div
                className={`${css.list_divider_y}`}
                style={{ backgroundColor: "#ddd", height: "5%" }}
              />
              <div
                      ...
                      card.Winner?._id === user?._id && (
                        <>
                          <span
                            ...
                            style={{ fontSize: "0.8em", color: "#343a40" }}
                          >
        ...
        {game && game.length === 0 && (
          <div className="text-center">
            <img
              src="https://i.postimg.cc/C10n1q2W/Add-a-heading-1-min.png"
              alt="no data"
              width={365}
              height={365}
              className="img-fluid"
